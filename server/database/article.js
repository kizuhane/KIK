export const articlesDB = [
      ...
      },
      {
        ...
        data: {
          ...
          content: [
            ...
            { type: "subsection", data: { text: "Subsection name 1 lorem" } },
            {
              type: "paragraph",
              data: {
                text:
      ...
      },
      {
        ...
        data: {
          ...
          content: [
            ...
            { type: "subsection", data: { text: "Subsection 1 Section 3" } },
            {
              type: "embed",
              data: {
                service: "youtube",
  ...
  },
  {
    ...
    articleBody: [
      { type: "title", data: { text: " Instalacja lesson 1 Windows Server" } },
      {
        type: "section",
        data: {
          text: "Section name 1",
  ...
  },
  {
    ...
    articleBody: [
      { type: "title", data: { text: " Instalacja lesson 2 Windows Server" } },
      {
        type: "section",
        data: {
          text: "Section name 1",
  ...
  },
  {
    ...
    articleBody: [
      { type: "title", data: { text: " Instalacja lesson 3 Windows Server" } },
      {
        type: "section",
        data: {
          text: "Section name 1",
